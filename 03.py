...
def next():
    ...
    Button(root3,text='Views', height="1",width="20", bd=8, font=('arial', 12, 'bold'), relief="groove", fg="black",
                   bg="white",command=view).pack()
    Label(root3,text="").pack()
...
def view():
    ...
    e = Label(my_w,width=30, text="Object Name",borderwidth=2, relief='ridge',anchor='w',bg="yellow")
    e.grid(row=0, column=0)
    e = Label(my_w,width=30, text="Time And Date",borderwidth=2, relief='ridge',anchor='w',bg="yellow")
    e.grid(row=0, column=1)
    i=1 
    for object in my_conn: 
        for j in range(len(object)):
            e = Label(my_w,width=30, text=object[j],borderwidth=2, relief='ridge',anchor='w',)
